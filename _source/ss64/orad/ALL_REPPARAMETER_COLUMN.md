...
---
<!-- #BeginLibraryItem "/Library/head_orad.lbi" --><!-- #EndLibraryItem --><h1>ALL_REPPARAMETER_COLUMN </h1><p> All columns used for resolving conflicts in replicated tables which are accessible to the user </p> 
