...
---
<!-- #BeginLibraryItem "/Library/head_orad.lbi" --><!-- #EndLibraryItem --><h1>USER_BASE_TABLE_MVIEWS </h1><p> 
All materialized views with log(s) </p><p>  owned by the user in the database </p> 
