...
---
<!-- #BeginLibraryItem "/Library/head_orad.lbi" --><!-- #EndLibraryItem --><h1>USER_TAB_COLUMNS </h1>
<p>Columns of user's tables, views and clusters </p> 
<pre>Columns
   ...
   HIDDEN_COLUMN
      The column exists in the table but cannot be selected. (mostly for internal use)
   VIRTUAL_COLUMN
      The column is an Oracle 11g Virtual column.</pre>
<p>Example<br>
</p>
<pre>select column_name, data_type, hidden_column, virtual_column
from user_tab_cols
where table_name = 'MY_XML_TABLE' ;</pre>
<p><b>Related:</b></p>
<pre> <a href="DBA_ALL_TABLES.html">DBA_ALL_TABLES</a>         <a href="ALL_ALL_TABLES.html">ALL_ALL_TABLES</a>       <a href="USER_ALL_TABLES.html"> USER_ALL_TABLES</a>
 ...
 <a href="DBA_TAB_COLUMNS.html">DBA_TAB_COLUMNS</a>        <a href="ALL_TAB_COLUMNS.html">ALL_TAB_COLUMNS</a>       USER_TAB_COLUMNS 
...
<hr>
<div id="bl" class="footer"><a href="USER_TAB_COLUMNS.html#"><img src="../images/top.png" width="30" height="22" alt="Back to the Top"></a></div>
