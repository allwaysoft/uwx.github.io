...
---
<!-- #BeginLibraryItem "/Library/head_orad.lbi" --><!-- #EndLibraryItem --><h1>ALL_XML_VIEW_COLS </h1><p> Description of the all XMLType views that the user has privileges on </p> 
