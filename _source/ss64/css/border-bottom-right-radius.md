...
---
<!-- #BeginLibraryItem "/Library/head_css.lbi" --><!-- #EndLibraryItem --><h1>Border-bottom-right-radius</h1>
<p>Curve the bottom-right corner in <span class="code">px, pt, em</span> or <span class="code">%</span>. </p>
<pre>Syntax
      border-bottom-right-radius: <i>length</i>|% [<i>length</i>|%] ;</pre>
...
<p>Examples:<br>
  <span class="code">h1 { border-bottom-right-radius: 40px 10px; }<br>
    .ss64class { border-bottom-right-radius: 12%; }</span><br>
    <span class="code">#SS64id { border-bottom-right-radius: 0.5em;  }</span>    <br>
</p>
...
<hr>
<div id="bl" class="footer"><a href="border-bottom-right-radius.html#"><img src="../images/top.png" width="30" height="22" alt="Back to the Top"></a></div>
