...
---
<!-- #BeginLibraryItem "/Library/head_osx.lbi" --><!-- #EndLibraryItem --><h1>dc</h1> 
<p>Desk calculator. </p>
<pre>Syntax
      dc</pre>
...
<h2>Arithmetic</h2>
<pre>   +    Pop two values off the stack, add them, and push the result.
...
<h2>Stack Control</h2>
<pre>   c     Clear the stack, rendering it empty.
...
<pre>   sr   Pop the value off the top of the stack and store it into register r.
...
<pre>       i      Pops the value off the top of the stack and uses it to set the
              input radix.
...
<pre>   &gt;r  Pops two values off the stack and compares  them assuming  they
...
<h2>Miscellaneous</h2>
<pre>   !     Will run the rest of the line as a system command.  Note that parsing of the !&lt;,
...
<p class="quote"><i>“The best way to destroy the capitalist system is to debauch the currency” ~ John Keynes </i> </p>
<p><b>Related:</b></p>
...
<a href="wc.html">wc</a> - Print byte, word, and line counts </p><!-- #BeginLibraryItem "/Library/foot_osx.lbi" --><p><script async="" src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<!-- OSX300 -->
