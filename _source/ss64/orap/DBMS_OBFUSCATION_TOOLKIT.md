...
---
<!-- #BeginLibraryItem "/Library/head_orapack.lbi" --><!-- #EndLibraryItem --><h1>PL/SQL Packages DBMS_OBFUSCATION_TOOLKIT</h1> 
<p>Encrypt data using either the Data Encryption Standard (DES) or 
  the Triple DES algorithms. </p>
<pre>Subprocedures:
...
<hr>
<div id="bl" class="footer"><a href="DBMS_OBFUSCATION_TOOLKIT.html#"><img src="../images/top.png" width="30" height="22" alt="Back to the Top"></a></div>
