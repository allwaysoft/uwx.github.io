...
---
<!-- #BeginLibraryItem "/Library/head_orapack.lbi" --><!-- #EndLibraryItem --><h1>PL/SQL Packages DBMS_TRACE</h1> 
<p>Trace PL/SQL functions, procedures, and exceptions.</p>
<pre>Subprocedures:
...
PLSQL_TRACE_VERSION Get the version number of the trace package.  </pre>
...
<hr>
<div id="bl" class="footer"><a href="DBMS_TRACE.html#"><img src="../images/top.png" width="30" height="22" alt="Back to the Top"></a></div>
