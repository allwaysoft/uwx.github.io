...
---
<!-- #BeginLibraryItem "/Library/head_orav.lbi" --><!-- #EndLibraryItem --><h1>V$INSTANCE </h1>  
...
<pre>Columns
   ...
   SHUTDOWN_PENDING
   DATABASE_STATUS
   INSTANCE_ROLE   (Primary or secondary instance)
   ACTIVE_STATE</pre>
...
<a href="V$VERSION.html">V$VERSION</a><br><a href="../orap/DBMS_UTILITY.html">dbms_utility</a>.db_version</pre><!-- #BeginLibraryItem "/Library/foot_orad.lbi" --><p><script async="" src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<!-- oracle-footer -->
