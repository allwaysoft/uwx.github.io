...
<h1>iCACLS.exe (2003 sp2, Vista+)</h1>
...
Equivalent bash command (Linux):<a href="../bash/chmod.html">chmod</a> / <a href="../bash/chown.html">chown</a> - Change file permissions/owner and group </p><!-- #BeginLibraryItem "/Library/foot_nt.lbi" --><p>
<!-- windows300 -->
