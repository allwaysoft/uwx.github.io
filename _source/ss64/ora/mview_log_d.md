...
---
<!-- #BeginLibraryItem "/Library/head_ora.lbi" --><!-- #EndLibraryItem --><h1>DROP MATERIALIZED VIEW LOG</h1> 
<p>Drop a materialized view log. The word "snapshot" is synonymous 
  with "materialized view". <br>
  <br>
  Syntax:</p>
<pre>   DROP MATERIALIZED VIEW LOG ON [<i>schema</i>.]<i>table</i>;
 
</pre>
<p><b> Related Commands:</b><br>
<br>
<a href="grant.html"> GRANT</a> ALTER 
ANY MATERIALIZED VIEW<br>
MVIEW - <a href="mview_d.html">DROP MATERIALIZED VIEW</a><br>
MVIEW LOG - <a href="mview_log_c.html">CREATE MATERIALIZED VIEW LOG</a> <br>
MVIEW LOG - <a href="mview_log_a.html">ALTER MATERIALIZED VIEW LOG</a> <br>
<br>
<b>Related Views:</b></p>
...
<hr>
<div id="bl" class="footer"><a href="mview_log_d.html#"><img src="../images/top.png" width="30" height="22" alt="Back to the Top"></a></div>
