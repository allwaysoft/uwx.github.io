...
let bconfig = config
  .replace(/source_dir: source/, 'source_dir: bsource/gameshark-htmls')
  .replace(/public_dir: public/, 'public_dir: bpublic/gameshark-htmls');

fs.writeFileSync('_config.yml', bconfig);

fs.mkdirsSync('bsource/gameshark-htmls/'); // make source dirs
fs.copySync('_source/gameshark-htmls/', 'bsource/gameshark-htmls/'); // copy real source to fake source
...
fs.mkdirsSync('public/gameshark-htmls/'); // make output folder
fs.copySync('bpublic/gameshark-htmls/', 'public/gameshark-htmls/'); // copy generated files to output folder
