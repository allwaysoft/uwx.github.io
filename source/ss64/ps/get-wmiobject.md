...
---
<!-- #BeginLibraryItem "/Library/head_ps.lbi" --><!-- #EndLibraryItem --><h1>Get-WmiObject</h1> 
...
<p>Uninstall a program (Paint.NET) from an elevated prompt, note the wildcard (%) is used to match multiple versions 3.1, 3.2…</p>
