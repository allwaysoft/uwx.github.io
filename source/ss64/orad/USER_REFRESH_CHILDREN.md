...
---
<!-- #BeginLibraryItem "/Library/head_orad.lbi" --><!-- #EndLibraryItem --><h1>USER_REFRESH_CHILDREN </h1><p>All the objects in refresh groups, where the user owns the refresh group </p> 
...
<hr>
<div id="bl" class="footer"><a href="USER_REFRESH_CHILDREN.html#"><img src="../images/top.png" width="30" height="22" alt="Back to the Top"></a></div>
