...
---
<!-- #BeginLibraryItem "/Library/head_orad.lbi" --><!-- #EndLibraryItem --><h1>USER_REPGENERATED </h1><p> Objects generated for the current user to support replication </p> 
...
<pre>Columns
   ...
   BASE_SNAME
      Name of the user
   BASE_ONAME
      Name of the user's object USER_REPGENERATED
   PACKAGE_PREFIX
