...
---
<!-- #BeginLibraryItem "/Library/head_nt.lbi" --><!-- #EndLibraryItem --><h1>SET</h1> 
...
Equivalent bash command (Linux): <a href="../bash/env.html">env</a> - Display, set, or remove environment variables</p><!-- #BeginLibraryItem "/Library/foot_nt.lbi" --><p>
<!-- windows300 -->
