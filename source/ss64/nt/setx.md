...
---
<!-- #BeginLibraryItem "/Library/head_nt.lbi" --><!-- #EndLibraryItem --><h1>SETX.exe (<a href="../links/windows.html#kits">Resource Kit</a>, Windows 7)</h1>
...
Echo %_result%</pre>
<p>Thanks to Aacini for suggesting improvements to this page over in the <a href="http://ss64.org/viewtopic.php?id=1788">forum</a>.</p>
...
Equivalent bash command (Linux): <a href="../bash/env.html">setenv</a> - Display, set, or remove environment variables.</p><!-- #BeginLibraryItem "/Library/foot_nt.lbi" --><p>
<!-- windows300 -->
