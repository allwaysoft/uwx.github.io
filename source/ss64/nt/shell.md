...
---
<!-- #BeginLibraryItem "/Library/head_nt.lbi" --><!-- #EndLibraryItem --><h1>Shell: folder shortcuts</h1>
...
<tr>
<td>Open the user‘s profile folder (same as <a href="syntax-variables.html">%<span class="code">USERPROFILE</span>%</a>)</td>
...
<tr>
<td>Open the user‘s Pictures folder</td>
...
<a href="run.html">RUN commands</a> Start | Run commands.</p><!-- #BeginLibraryItem "/Library/foot_nt.lbi" --><p>
<!-- windows300 -->
