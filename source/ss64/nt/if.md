...
---
<!-- #BeginLibraryItem "/Library/head_nt.lbi" --><!-- #EndLibraryItem --><h1>IF</h1> 
...
i.e.<br>
<span class="code">IF ERRORLEVEL 0 </span>will return TRUE when the errorlevel is 64 </p>
<p>A more precise method of checking Errorlevels is to use the  <span class="code">%ERRORLEVEL%</span> variable:</p>
<p><span class="code">IF %ERRORLEVEL% GTR 0 Echo An error was found<br>
IF %ERRORLEVEL% LSS 0 Echo An error was found<br>
<br>
...
<a href="../bash/if.html">if</a> - Conditionally perform a command</p><!-- #BeginLibraryItem "/Library/foot_nt.lbi" --><p>
<!-- windows300 -->
