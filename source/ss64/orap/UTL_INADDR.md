...
---
<!-- #BeginLibraryItem "/Library/head_orapack.lbi" --><!-- #EndLibraryItem --><h1>PL/SQL Packages UTL_INADDR</h1> 
<p>Internet Addressing. <br>
  Determine the host name or IP address of a local or remote host.</p>
<pre>Subprocedures:
...
<hr>
<div id="bl" class="footer"><a href="UTL_INADDR.html#"><img src="../images/top.png" width="30" height="22" alt="Back to the Top"></a></div>
