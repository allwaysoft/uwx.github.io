...
---
<!-- #BeginLibraryItem "/Library/head_orapack.lbi" --><!-- #EndLibraryItem --><h1>PL/SQL Packages DBMS_IOT</h1> 
<p>Create tables into which references to chained rows/exceptions 
  for an index organized table can be placed.</p>
<pre>Subprocedures:
...
Related Commands:<br></b><br><a href="../ora/analyze.html">ANALYZE</a></span></pre>
...
<hr>
<div id="bl" class="footer"><a href="DBMS_IOT.html#"><img src="../images/top.png" width="30" height="22" alt="Back to the Top"></a></div>
