...
---
<!-- #BeginLibraryItem "/Library/head_orapack.lbi" --><!-- #EndLibraryItem --><h1>PL/SQL Packages DBMS_DEFER</h1> 
<p>Replicated applications use the calls in this interface to queue 
  procedure calls for later transactional execution at remote nodes.</p>
<pre>Subprocedures:
...
<hr>
<div id="bl" class="footer"><a href="DBMS_DEFER.html#"><img src="../images/top.png" width="30" height="22" alt="Back to the Top"></a></div>
