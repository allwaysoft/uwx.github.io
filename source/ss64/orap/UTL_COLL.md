...
---
<!-- #BeginLibraryItem "/Library/head_orapack.lbi" --><!-- #EndLibraryItem --><h1>PL/SQL Packages UTL_COLL</h1> 
<p>Allow PL/SQL programs to use collection locators to query and 
  update.</p>
<pre>Subprocedures:
...
<hr>
<div id="bl" class="footer"><a href="UTL_COLL.html#"><img src="../images/top.png" width="30" height="22" alt="Back to the Top"></a></div>
