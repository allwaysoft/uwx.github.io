...
---
<!-- #BeginLibraryItem "/Library/head_orav.lbi" --><!-- #EndLibraryItem --><h1>V$RECOVER_FILE </h1>  
 <p> Lists datafiles that need recovery. Join FILE# with v$datafile to see filenames.</p> 
...
<a href="V$RECOVERY_STATUS.html">V$RECOVERY_STATUS</a></pre><!-- #BeginLibraryItem "/Library/foot_orad.lbi" --><p>
<!-- oracle-footer -->
...
<hr>
<div id="bl" class="footer"><a href="V$RECOVER_FILE.html#"><img src="../images/top.png" width="30" height="22" alt="Back to the Top"></a></div>
