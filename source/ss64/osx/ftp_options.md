...
---
<!-- #BeginLibraryItem "/Library/head_osx.lbi" --><!-- #EndLibraryItem --><h1>ftp - full options list</h1> 
...
Advanced Options
     ...
     -P <i>port</i>  Sets the port number to port.
...
<a id="naming"></a>FILE NAMING CONVENTIONS
</pre>
<blockquote>
...
getservbyname(3), editrc(5), services(5), ftpd(8)</p><!-- #BeginLibraryItem "/Library/foot_osx.lbi" --><p>
<!-- OSX300 -->
