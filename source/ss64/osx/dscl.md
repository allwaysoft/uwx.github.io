...
---
<!-- #BeginLibraryItem "/Library/head_osx.lbi" --><!-- #EndLibraryItem --><h1>dscl</h1> 
...
Equivalent (Linux) bash command:<span class="code"> ldapmodify</span> - LDAP modify entry and LDAP add entry tools</p><!-- #BeginLibraryItem "/Library/foot_osx.lbi" --><p>
<!-- OSX300 -->
