...
---
<!-- #BeginLibraryItem "/Library/head_osx.lbi" --><!-- #EndLibraryItem --><h1>zip</h1> 
...
<pre>       Command format.  The basic command format is
       ...
       negating in the future.</pre>
<h2> EXAMPLES<br>
</h2>
<pre>       The simplest example:
...
<pre>   0      normal; no errors or warnings detected.
...
<p><b>Related:</b></p>
<p>zipcloak (see  man page)        <br>
zipnote (see  man page)        <br>
zipsplit (see  man page)<br>
<a href="tar.html">tar</a> - Store, list or extract files in an archive<br>
compress(1), shar(1L), unzip(1L), gzip(1L)</p><!-- #BeginLibraryItem "/Library/foot_osx.lbi" --><p>
<!-- OSX300 -->
