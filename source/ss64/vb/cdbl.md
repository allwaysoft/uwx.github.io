...
---
<!-- #BeginLibraryItem "/Library/head_vb.lbi" --><!-- #EndLibraryItem --><h1>CDbl</h1> 
...
<p>CDbl cannot handle Null values.</p>
<p>Example</p>
<p class="code">Dim dblDemo<br>dblDemo = CDbl(12 * 0.000001)</p>
