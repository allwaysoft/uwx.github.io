...
---
<!-- #BeginLibraryItem "/Library/head_bash.lbi" --><!-- #EndLibraryItem --><h1>less</h1> 
...
<pre>  e  ^E  j  ^N  CR  *  Forward  one line   (or N lines).
...
<pre>  /pattern          *  Search forward for (N-th) matching line.
...
<pre>  g  &lt;  ESC-&lt;       *  Go to first line in file (or line N).
...
<a href="../nt/more.html">MORE</a> - Display output one screen at a time.</p><!-- #BeginLibraryItem "/Library/foot_bash.lbi" --><p>
<!-- bash300 -->
